...
function createShieldRepublicWholesaleApparel(Queue $queue, Shop $shop, Template $template, Setting $setting = null)
{
    global $s3;
    $matrix = json_decode(file_get_contents(DIR.'/src/sr_wholesale.json'), true);
    if (!$matrix) {
